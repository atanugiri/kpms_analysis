...
# repo directory structure (results/, logs/, etc.)
cd "$WORK/kpms_analysis"

# Step 4: Fit PCA
# Note: This reads preprocessed/formatted data that should already exist
# in results/<project>/kpms_project/ and the calibrated config from the
